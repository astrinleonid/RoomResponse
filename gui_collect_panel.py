#!/usr/bin/env python3
"""
GUI Collection Panel — DROP-IN REPLACEMENT (v7)

v7 changes:
- Added channel exploration and visualization features
- Support for browsing by channel and overlaying measurements
- Side-by-side channel comparison visualization
...
try:
    ...
    group_files_by_channel = None  # type: ignore
    parse_multichannel_filename = None  # type: ignore
...
class CollectionPanel:
    ...
    def render(self) -> None:
        ...
        # Channel exploration and visualization section
        st.markdown("---")
        self._render_channel_exploration(root)
...
class SingleScenarioExecutor:
    ...
    def _render_channel_exploration(self, root: str) -> None:
        ...
        if group_files_by_channel is None or parse_multichannel_filename is None:
        ...
        is_multichannel = self.scenario_manager.is_multichannel_scenario(scenario_path) if self.scenario_manager else False
    ...
    def _get_scenarios_list(self, root: str) -> List[str]:
    ...
    def _render_by_measurement_view(self, scenario_path: str, scenario_name: str) -> None:
        ...
        # Get measurements
        measurements_dict = self.scenario_manager.list_wavs_multichannel(scenario_path) if self.scenario_manager else {}
